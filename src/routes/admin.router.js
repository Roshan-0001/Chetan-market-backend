...
import { deleteSingleUser, loginAdmin, logoutAdmin, registerAdmin, viewAllUsers, viewSingleUser, viewAllAdmins, deleteSingleAdmin, registerMultipleUsers } from "../controllers/admin.controller.js";
...
adminRouter.route("/register-multiple-user").post(verifyAdminJWT,upload.fields([{ name: "profileImage", maxCount: 20 }]),registerMultipleUsers);
